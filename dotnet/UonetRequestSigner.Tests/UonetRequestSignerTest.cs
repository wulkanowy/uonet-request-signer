...
namespace Wulkanowy
{
    public class UonetRequestSignerTest
    {
        ...
        [Test]
        public void GetPrivateKeyFromCert()
        {
            Assert.AreEqual(PrivateKey, UonetRequestSigner.GetPrivateKeyFromCertEncoded(Password, Certificate));
        }
    }
}
